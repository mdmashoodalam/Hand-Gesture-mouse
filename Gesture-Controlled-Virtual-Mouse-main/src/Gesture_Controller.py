...
import pyautogui #automatic task keyboard and mouse inputs
import math #calculating distance between point
from enum import IntEnum #Enum for mapping all hand gesture to binary number
from ctypes import cast, POINTER 
from comtypes import CLSCTX_ALL #Audio volume control
from pycaw.pycaw import AudioUtilities, IAudioEndpointVolume  #sets system volume based on 
from google.protobuf.json_format import MessageToDict
import screen_brightness_control as sbcontrol #screen brightness control
